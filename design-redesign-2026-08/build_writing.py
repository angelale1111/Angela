...
<div class="annot"><b>DRAFT — local preview only, nothing built into Lovable yet.</b>Switched to Option 3: centered, photo above the line. This section now reuses the same markup pattern and the same 1.875rem headline size as the homepage's own "The Writing" block, so the two should read as identical in scale.</div>
