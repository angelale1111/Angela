...
{FONT_FACES}
  ...
  * {{ box-sizing: border-box; }}
  ...
  .bio-wrap p.bio-p {{ font-size: 1.0625rem; line-height: 1.9; margin-bottom: 1.75rem; }}
...
<div class="annot">DRAFT — local preview only, nothing built into Lovable. Copy is verbatim from the live About page source.</div>
...
<section class="closing-section">
  ...
  <a href="#" class="btn">Begin a Conversation</a>
