...
{FONT_FACES}
  ...
  * {{ box-sizing: border-box; }}
  ...
  .bio-columns {{ display: flex; gap: 3.5rem; align-items: flex-start; margin-bottom: 1rem; }}
  .bio-photo-col {{ position: relative; width: 340px; aspect-ratio: 1769 / 2048; overflow: hidden; flex-shrink: 0; }}
  .bio-photo-col img {{ width: 100%; height: 100%; object-fit: cover; object-position: 50% 20%; display: block; }}
  .bio-text-col {{ flex: 1; }}
