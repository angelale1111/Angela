...
bio_paragraphs = [
    ...
    "Her training began under Master Ni and his sons, heirs to a 74-generation Taoist lineage. From that foundation, she built an integrated practice drawing on Traditional Chinese Medicine, somatic healing, and longevity science, a way of working that belongs to no single tradition.",
    "Dr. Le is the founder of Fifth Avenue Fertility Wellness in New York City. This website is where she offers private consultations and ongoing mentorship, work that meets women in the wider questions of health, intimacy, and authorship. She writes on Substack and lives in New York City.",
]
...
{FONT_FACES}
  ...
  * {{ box-sizing: border-box; }}
  ...
  .bio-columns {{ display: flex; gap: 3.5rem; align-items: center; margin-bottom: 1rem; }}
  .bio-photo-col {{ position: relative; width: 340px; height: 460px; overflow: hidden; flex-shrink: 0; }}
  .bio-photo-col img {{ position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover; object-position: 50% 10%; display: block; }}
  .bio-text-col {{ flex: 1; }}
